...
- 控件类型分布:
  ...
  - Scroll: 1
  - Toggle: 1
- 文本内容: ['空调用电数据源', '未设置，电费页不显示空调用电', '›', '课表相关设置', '开启课表背景图', '课表背景图选择', '›', '清除所有用户添加课程', '›', '强制刷新课表', '›', '课程偏移设置', '正数错后开学日期 负数提前开学日期\n目前为 0', '›', '修改学期', '使用学期', '›', '缓存登录设置', '校園信息', '睿思論壇', '其他功能', '豬圖鑑賞', '設置']
...
- 尺寸列表: [('Row()', 1202, 259), ('Toggle(settingsBackgroundToggle)', 196, 119), ('Row()', 1202, 287), ('Row()', 1202, 287), ('Row()', 1202, 287), ('Row()', 1202, 329), ('Row()', 1202, 287), ('Column(navTo_home)', 259, 273), ('Column(navTo_ruisi)', 259, 273), ('Column(navTo_toolbox)', 259, 273), ('Column(navTo_pig)', 259, 273), ('Column(navTo_settings)', 259, 273)]

### 文本控件尺寸
- ⚠️ 高度过小的文本控件（h<20px，可能字体过小）: ['"缓存登录设置" h=19']
- 文本控件高度分布: [19, 49, 57, 66, 114, 123]
