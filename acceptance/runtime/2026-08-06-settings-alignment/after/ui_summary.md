...
目前為 0"
            ...
            - Column 1202×1022
              - Row 1202×154
                - Text 336×66 text="緩存登錄設置"
              - Column 1202×868
                - Column 1202×291
                  - Row 1202×287 [clickable]
                    - Column 972×66
                      - Text 560×66 text="查看網絡攔截器和日誌"
                    - Text 34×123 text="›"
                  - Divider 1104×4
                - Column 1202×291
                  - Row 1202×287 [clickable]
                    - Column 972×66
                      - Text 392×66 text="清除緩存後重啟"
                    - Text 34×123 text="›"
                  - Divider 1104×4
                - Column 1202×287
                  - Row 1202×287 [clickable]
                    - Column 972×66
                      - Text 504×66 text="退出登錄並重啟應用"
                    - Text 34×123 text="›"
            - Blank 1202×42
    - Row 1320×308
...
- 控件类型分布:
  ...
  - Scroll: 1
  - Blank: 1
- 文本内容: ['清除所有用戶添加課程', '›', '強制刷新課表', '›', '課程偏移設置', '正數錯後開學日期 負數提前開學日期\n目前為 0', '›', '修改學期', '使用學期', '›', '緩存登錄設置', '查看網絡攔截器和日誌', '›', '清除緩存後重啟', '›', '退出登錄並重啟應用', '›', '校園信息', '睿思論壇', '其他功能', '豬圖鑑賞', '設置']
...
### 间距分析
- 同级元素垂直间距: 最小=0px, 最大=27px, 平均=5.8px
