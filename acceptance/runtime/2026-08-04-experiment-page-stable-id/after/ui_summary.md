  ...
  - Column 1320×2621
    - Column 1320×2313
      - Column 1320×2313
        ...
        - Text 760×49 text="其他实验等待真实 IDS 会话恢复后联调。" key="experimentStatus"
        - Row 1194×133
        ...
        - Scroll 1194×1625
          - Column 1194×288
            - Text 1176×218 text="其他实验数据来自 sysj.xidian.edu.cn，必须完成真实 IDS OAuth 跳转；Mock 登录不返回可用 Cookie。" key="experimentOtherBlocked"
            - Blank 1194×70
    - Row 1320×308
...
- 控件类型分布:
  ...
  - Scroll: 1
  - Blank: 1
- 文本内容: ['‹', '实验信息', '刷新', '其他实验等待真实 IDS 会话恢复后联调。', '物理实验', '其他实验', '进行中', '未完成', '已完成', '其他实验数据来自 sysj.xidian.edu.cn，必须完成真实 IDS OAuth 跳转；Mock 登录不返回可用 Cookie。', '校園信息', '睿思論壇', '其他功能', '豬圖鑑賞', '設置']
...
- 文本控件高度分布: [49, 98, 119, 133, 140, 218]
