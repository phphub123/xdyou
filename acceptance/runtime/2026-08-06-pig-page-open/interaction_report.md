...
| 3 | snapshot | PASS | 快照保存至 acceptance/runtime/2026-08-06-pig-page-open/snapshot_01-pig-loaded |

## 交互前后界面差异

**摘要**: 新增 43 个节点; 移除 30 个节点; 文本变化 12 处; 属性变化 51 处; 数量变化: genericContainer: 2→0, rootWebArea: 1→0, Column: 2→9, TextInput: 2→0, Stack: 15→14, Row: 10→16, Image: 0→9, Button: 2→0, Text: 12→14, Web: 1→0
...
- `text:Change A Pig` (Text) Change A Pig
...
- `text:豬圖鑑賞` (Text) 豬圖鑑賞
- `type:Row#13` (Row) 
- `text:Save this Pig` (Text) Save this Pig
