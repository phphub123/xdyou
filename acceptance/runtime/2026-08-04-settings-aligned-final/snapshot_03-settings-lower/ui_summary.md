...
- 尺寸列表: [('Row()', 1202, 271), ('Toggle(settingsBackgroundToggle)', 196, 119), ('Row()', 1202, 287), ('Row()', 1202, 287), ('Row()', 1202, 287), ('Row()', 1202, 329), ('Row()', 1202, 287), ('Column(navTo_home)', 259, 273), ('Column(navTo_ruisi)', 259, 273), ('Column(navTo_toolbox)', 259, 273), ('Column(navTo_pig)', 259, 273), ('Column(navTo_settings)', 259, 273)]

### 文本控件尺寸
- ⚠️ 高度过小的文本控件（h<20px，可能字体过小）: ['"缓存登录设置" h=7']
- 文本控件高度分布: [7, 49, 57, 66, 114, 123]
